...
class Cloudinary::Static
  ...
  def self.sync(options={})
    ...
    self.discover do
      ...
      public_path_with_images = public_path.to_s.starts_with?("images") ? public_path : "images/#{public_path}"

      metadata_lines << [public_path_with_images, public_id, result["upload_time"].to_i, result["version"], result["width"], result["height"]].join("\t")+"\n"
    end
